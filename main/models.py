...
class kechengxinxi(BaseModel):
    ...
    shangkexuesheng=models.TextField   (  null=True, unique=False, verbose_name='上课学生' )
...
class kechengyuyue(BaseModel):
    __doc__ = u'''kechengyuyue'''
    __tablename__ = 'kechengyuyue'



    __authTables__={'jiaoshizhanghao':'jiaoshi','xuehao':'xuesheng',}
    __authPeople__='否'#用户表，表属性loginUserColumn对应的值就是用户名字段，mima就是密码字段
    ...
    yuyueshizhang=models.CharField ( max_length=255, null=True, unique=False, verbose_name='预约时长' )
    yuyueyuanyin=models.TextField   ( null=False, unique=False, verbose_name='预约原因' )
    jiaoshizhanghao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='教师账号' )
    jiaoshixingming=models.CharField ( max_length=255, null=True, unique=False, verbose_name='教师姓名' )
    ...
    '''
    class Meta:
        db_table = 'kechengyuyue'
        verbose_name = verbose_name_plural = '课程预约'
class quxiaoyuyue(BaseModel):
    ...
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    kechengmingcheng=models.CharField ( max_length=255, null=True, unique=False, verbose_name='课程名称' )
    quxiaoshijian=models.DateTimeField  (  null=True, unique=False, verbose_name='取消时间' )
    quxiaoyuanyin=models.TextField   ( null=False, unique=False, verbose_name='取消原因' )
    jiaoshizhanghao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='教师账号' )
    jiaoshixingming=models.CharField ( max_length=255, null=True, unique=False, verbose_name='教师姓名' )
    xuehao=models.CharField ( max_length=255, null=True, unique=False, verbose_name='学号' )
    xingming=models.CharField ( max_length=255, null=True, unique=False, verbose_name='姓名' )
    ...
    '''
    class Meta:
        db_table = 'quxiaoyuyue'
        verbose_name = verbose_name_plural = '取消预约'
